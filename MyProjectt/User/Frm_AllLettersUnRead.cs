...
{
    public partial class Frm_AllLettersUnRead : Form
    {
        public Frm_AllLettersUnRead()
        {
            InitializeComponent();
        }

        private void Frm_AllLettersUnRead_Load(object sender, EventArgs e)
        {
            this.Top = 109;
            this.Left = 0;
        ...
        private void GetAllLetterUser()
        {
            ...
            {
                IEnumerable<SendLetter> list = db.LetterRepository.GetAllUnreadLatterByUserID(ListUserVariable.UserID, Dtf, DTt, GetSearch());
