...
{
    public partial class Frm_ShowLetterrefrence : Form
    {
        public Frm_ShowLetterrefrence()
        {
            InitializeComponent();
        }
        ...
        private void btn_exit_Click(object sender, EventArgs e)
        {
            ...
            {
                bool istrue = db.RefrenceLetterRepository.UpdateLetterrefrenceByUserID(ListUserVariable.UserID);
                if (istrue)
                {
                    db.Save();
                    this.Close();
