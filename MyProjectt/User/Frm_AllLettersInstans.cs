...
{
    public partial class Frm_AllLettersInstans : Form
    {
        public Frm_AllLettersInstans()
        {
            InitializeComponent();
        }

        private void Frm_AllLettersInstans_Load(object sender, EventArgs e)
        {
            this.Top = 109;
            this.Left = 0;
        ...
        private void GetAllLetterUser()
        {
            ...
            {
                var list = db.LetterRepository.GetAllInstansLatterByUserID(ListUserVariable.UserID, Dtf, DTt, GetSearch());
                ...
                if (list.Count() != 0)
                {
                    foreach (var item in list)
                    {
                        ...
                        item.Letter.LetterSubject, item.FullNameSender,
